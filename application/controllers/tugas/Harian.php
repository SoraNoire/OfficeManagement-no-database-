...
class Harian extends CI_Controller {
    ...
    public function form_edit_tugas(){
        ...
        //echo $data['detail'];
        echo "<script src='<?= base_url();?>assets/tinymce/tinymce.min.js'></script>
                <script>tinymce.init({ 
              selector:'textarea',
        ...
        echo "<form class='form-horizontal' method='post' enctype='multipart/form-data' action='".base_url()."tugas/harian/update_tugas'>
    ...
    public function update_tugas()
    {
        ...
        header('location:'.base_url().'tugas/harian/edit/'.$tgl);
        //redirect('tugas/harian/edit');
        //echo json_encode(array("status" => TRUE));
    }
