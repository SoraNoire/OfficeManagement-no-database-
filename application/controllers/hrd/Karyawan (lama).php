...
class Karyawan extends CI_Controller {
	...
	function data(){
		...
		$columns 	= array(
			...
			array(
				...
				'dt' => 'aksi',
				'formatter' => function($d){
					return "<a class=\"btn btn-xs btn-warning\" title=\"edit user\" href=".base_url()."hrd/karyawan/edit/$d><i class=\"glyphicon glyphicon-pencil\"></i> Edit</a> <a class=\"btn btn-xs btn-info\" title=\"create history\" href=".base_url()."hrd/karyawan/history/$d><i class=\"fa fa-list\"></i> History</a> ".anchor("hrd/karyawan/nonaktifkan/$d" ,'<i class="glyphicon glyphicon-remove"></i>', array('class'=>'btn btn-danger btn-xs', 'title'=>'non aktifkan', 'onclick'=>'javasciprt: return confirm(\'Anda yakin ingin menonaktifkan user ini !! \')'))."";
				})
			);
		$sql_details = array(
    ...
    {  
        ...
        header('location:'.base_url().'hrd/karyawan/edit/'.$id);
    }
