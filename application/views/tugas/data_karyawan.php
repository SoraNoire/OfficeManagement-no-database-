          ...
          <div class="x_content">
            <div class="" role="tabpanel" data-example-id="togglable-tabs">
              <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                <li role="presentation" class="active"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Data Tugas per Lokasi & Department Karyawan</a>
                </li>
                <li role="presentation" class=""><a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Data Tugas per Karyawan</a>
                </li>
              </ul>
                      ...
                      <div class="controls">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-5 col-sm-9 col-xs-9">
                            <button type="button" onclick="loadDataKaryawanAll()" class="btn btn-success"><i class="fa fa-search"></i> Search</button>
                          </div>
                        </div>
                      </div>
                    </div>
...
<script type="text/javascript">
  ...
  function loadDataKaryawanAll(){
    ...
    $.ajax({
      type :'GET',
      url  :'<?= base_url('tugas/data_harian/dataTugasAll') ?>',
      data :'start='+start+'&end='+end+'&posisi='+posisi+'&department='+department,
      //data :'department='+department+'&jabatan='+jabatan,
      success:function(html){
        $("#data_tugas").html(html);
      }
