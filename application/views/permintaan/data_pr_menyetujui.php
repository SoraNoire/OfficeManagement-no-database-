  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Data Permintaan Pembelian Disetujui<small></small></h2>
            <div class="clearfix"></div>
          </div>
                ...
                <tbody>
                  <?php
                    ...
                    $sql = "SELECT ap.*, ak.id_karyawan, ak.nama_lengkap
                            ...
                            WHERE ap.id_pt = '$pt' AND ap.pr_input = ak.id_karyawan AND ap.status_pr != 'baru' ORDER BY ap.status_pr ASC";
                    ...
                    foreach ($tugas as $row) {
                      echo "<tr>
                            ...
                            if($status == 'diketahui'){
                      echo  "<td>
                              <a class='btn btn-xs btn-warning' href='".base_url()."permintaan/pr/proses_menyetujui/$row->id_permintaan'><i class='fa fa-check'></i> Approve</a>
