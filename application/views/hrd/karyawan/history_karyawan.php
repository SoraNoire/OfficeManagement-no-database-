  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Form History<small></small></h2>
          ...
          <div class="x_content">
            <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>hrd/karyawan/proses_history">
              <div class="form-group">
                <input type="hidden" name="karyawan" value="<?= $this->uri->segment(4); ?>">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">Kategori History</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <select name="kategori" class="form-control" required="true">
                    <option value="">-- pilih kategori --</option>
                    <option value="mutasi perusahaan">Mutasi Perusahaan</option>
                    <option value="mutasi lokasi">Mutasi Lokasi Kerja</option>
                    <option value="gaji">Perubahan Gaji</option>
                    <option value="mutasi jabatan">Mutasi Jabatan</option>
                    <option value="rotasi jabatan">Rotasi Jabatan</option>
              ...
              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">Keterangan History</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <textarea name="keterangan" required="true" placeholder="detail history karyawan" style="resize:none; width:100%; height:150px;" class="form-control"></textarea>
                </div>
              </div>
              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">Tanggal Aktif</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" required="true" name="tgl_aktif" data-inputmask="'mask': '99-99-9999'" id="datepicker-example1" placeholder="pilih tanggal" class="form-control col-md-7 col-xs-12 tanggal">
                </div>
              </div>
