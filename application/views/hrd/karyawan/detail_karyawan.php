  ...
  <div class="">
    <div class="page-title">
      <div class="title_left">
        <h3><i class="fa fa-user"></i> Data Detail Karyawan</h3>
      </div>
    </div>
    <?php
        ...
        <div class="x_panel">
          <div class="x_title">
            ...
            <ul class="nav navbar-right panel_toolbox">
                <a class="btn btn-sm btn-warning" href="<?= base_url('hrd/karyawan/all') ?>"><i class="fa fa-reply"></i> Kembali</a>
            </ul>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
              ...
              <a class="btn btn-info"><i class="fa fa-list"></i> Status - <?= $record['status'] ?></a>

            </div>
            <div class="col-md-9 col-sm-9 col-xs-12">
              <div class="" role="tabpanel" data-example-id="togglable-tabs">
                <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                  <li role="presentation" class="active"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Data Detail Karyawan</a>
                  </li>
                </ul>
                <div id="myTabContent" class="tab-content">
                  <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                      <h2>Alamat Tinggal Sekarang</h2><hr>
                      <div class="form-body">
                        <div class="form-group">
