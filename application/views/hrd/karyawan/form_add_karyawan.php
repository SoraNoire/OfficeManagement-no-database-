    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?= base_url(); ?>hrd/karyawan/add_karyawan">
                            ...
                            <div class="col-md-8">
                              <div class="thumbnail">
                                <div class="view view-first">
                                  <img id="preview" style="width: 100%; height: 200px ; display: block;" src="<?= base_url() ?>assets/foto_karyawan/user.png" alt="foto karyawan" />
                                </div>
                              </div>
                            </div>
                          <div class="col-md-12">
                    ...
                    <div class="col-md-8 col-sm-12 col-xs-12">
                      <div class="form-body">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-md-9 col-sm-12">
                                  <input name="kode_karyawan" placeholder="nik - karyawan" required="true" class="form-control" type="text" data-inputmask="'mask': '9999999999999999999'">
                                  <span class="help-block"></span>
                              </div>
                          </div>
                          <div class="form-group">
                              ...
                              <div class="col-md-5 col-sm-12">
                                  <?php
                                    echo cmb_dinamis('department','abe_department','nama_department','nama_department');
                                  ?>
                                  <span class="help-block"></span>
                              </div>
                              <div class="col-md-4 col-sm-12">
                                  <?php
                                    echo cmb_dinamis('jabatan','abe_jabatan','nama_jabatan','nama_jabatan');
                                  ?>
                                  <span class="help-block"></span>
                              </div>
                          </div>
                          <div class="form-group">
                              ...
                              <div class="col-md-4 col-sm-12">
                                  <input name="tempat_lahir" required="true" placeholder="tempat lahir" class="form-control" type="text">
                                  <span class="help-block"></span>
                              </div>
                              <div class="col-md-5 col-sm-12">
                                  <input name="tgl_lahir" required="true"  type="text" data-inputmask="'mask': '99-99-9999'" id="datepicker-example1" placeholder="pilih tanggal" class="form-control tanggal" >
                                  <span class="help-block"></span>
                              </div>
                          </div>
                          <div class="form-group">
                              ...
                              <div class="col-md-9 col-sm-12">
                                  <input name="nik_ktp" placeholder="nik - ktp" required="true" class="form-control" type="text" data-inputmask="'mask': '9999999999999999'">
                                  <span class="help-block"></span>
                              </div>
                          </div>
                          <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-12 col-xs-12">
                          <select required="true" id="propinsi" name="propinsi_ktp" onchange="loadKabupaten()" class="form-control">
                            <?php
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-12 col-xs-12">
                          <textarea class="form-control" required="true" name="alamat_ktp"></textarea>
                          <span class="help-block"></span>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6 col-sm-12 col-xs-12">
                      ...
                      <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8 col-sm-12 col-xs-12">
                              <textarea class="form-control" required="true" name="alamat"></textarea>
                              <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                          ...
                          <div class="col-md-8 col-sm-12 col-xs-12">
                              <input name="hubungan_kerabat" placeholder="ibu, ayah, kakak, adik, sodara" class="form-control" type="text">
                              <span class="help-block"></span>
                          </div>
                        </div>
                        <div class="form-group">
                          ...
                          <div class="col-md-8 col-sm-12 col-xs-12">
                              <input name="nama_kerabat" placeholder="nama lengkap" class="form-control" type="text">
                              <span class="help-block"></span>
                          </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                      <h2>Data Perusahaan</h2><hr>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8 col-sm-12 col-xs-12">
                                <?php
                                  echo cmb_dinamis('posisi','abe_kota','nama_kota','nama_kota');
                                ?>
                                <span class="help-block"></span>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                      ...
                      <div class="form-body">
                        <div class="form-group">
                          ...
                          <div class="col-md-8 col-sm-12 col-xs-12">
                              <input name="gapok" id="harga" class="form-control" type="text">
                              <span class="help-block"></span>
                          </div>
                        </div>
                        <div class="form-group">
                          ...
                          <div class="col-md-8 col-sm-12 col-xs-12">
                              <input name="ac_rekening" placeholder="9876543210" data-inputmask="'mask': '9999999999'"  class="form-control" type="text">
                              <span class="help-block"></span>
                          </div>
                        </div>
                        <div class="form-group">
                          ...
                          <div class="col-md-8 col-sm-12 col-xs-12">
                              <input name="an_rekening" placeholder="an. rekening" class="form-control" type="text">
                              <span class="help-block"></span>
                          </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                      <h2>Data BPJS</h2><hr>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-8 col-sm-12 col-xs-12">
                              <input name="nomor_jpk" placeholder="nomor jpk" data-inputmask="'mask': '9999999999999999'"  class="form-control" type="text">
                              <span class="help-block"></span>
                          </div>
                        </div> 
                    </div>
                    <div class="col-md-6 col-sm-12 col-xs-12">
                      ...
                      <div class="form-body">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-8 col-sm-12 col-xs-12">
                              <input name="nomor_npwp" placeholder="nomor npwp" data-inputmask="'mask': '999999999999999'"  class="form-control" type="text">
                              <span class="help-block"></span>
                          </div>
                        </div>
                        <div class="form-group">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body form">
                <form action="#" id="form2"  class="form-horizontal">
                    ...
                    <div class="form-body">
                      <input type="hidden" name="id_karyawan" value="0" class="form-control" readonly="true" >
