        ...
        <div class="x_panel">
          ...
          ?>
            <div class="alert alert-info alert-dismissible" role="alert">
              ...
              <p><center>Hari ini anda belum Absen <br>Mohon isi Absen anda terlebih dahulu<br>Terimakasih (^_^)</center></p>
            </div>
          <?php
            }else{
              if($absen['tgl_pulang'] == 0 AND $absen['tgl_absen'] != 0){
          ?>
            <div class="alert alert-info alert-dismissible" role="alert">
              <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
              <p><center>Selamat Bekerja <br>Mohon klik "Absen Pulang" anda terlebih dahulu<br>sebelum meninggalkan kantor<br>Terimakasih (^_^)</center></p>
            </div>
          <?php
            } else if($absen['tgl_absen'] == 0){
          ?>
            <div class="alert alert-info alert-dismissible" role="alert">
              <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
              <p><center>Hari ini anda belum Absen <br>Mohon isi Absen anda terlebih dahulu<br>Terimakasih (^_^)</center></p>
          ...
          ?>
            <div class="alert alert-info alert-dismissible" role="alert">
              <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
              <p><center>Hati-hati di jalan ya'<br>sampai jumpa kembali<br>Terimakasih (^_^)</center></p>
            </div>
          <?php
            }
            }
          ...
          <?php 
            if($absen == 0){
          ?>
            <a class="btn btn-sm btn-success" href="<?= base_url('user/absen/masuk') ?>"><i class="fa fa-download"></i> Absen Masuk</a>
            <a class="btn btn-sm btn-danger" disabled="true"><i class="fa fa-upload"></i> Absen Pulang</a>
          <?php
            }else if($absen['status']== 'datang terlambat' OR $absen['status']== 'datang siang'){
              if($absen['tgl_pulang'] == 0 AND $absen['tgl_absen'] != 0){
          ?>
              <a class="btn btn-sm btn-success" disabled="true" ><i class="fa fa-download"></i> Absen Masuk</a>
              <?php
                echo anchor('user/absen/pulang/','<i class="fa fa-upload"></i> Absen Pulang', array('class'=>'btn btn-danger btn-sm', 'title'=>'keluar/pulang', 'onclick'=>'javasciprt: return confirm(\'Anda yakin ingin pulang sekarang !! \')'));
              ?>
          <?php
              }else if($absen['tgl_absen'] == 0){
          ?>
              <a class="btn btn-sm btn-success" href="<?= base_url('user/absen/masuk_telat') ?>"><i class="fa fa-download"></i> Absen Masuk</a>
              <a class="btn btn-sm btn-danger" disabled="true"><i class="fa fa-upload"></i> Absen Pulang</a>
          <?php
              }else{
          ?>
          ...
          <?php
            ...
            }else if($absen['status']== 'sakit' OR $absen['status']== 'cuti' OR $absen['status'] == 'mangkir'){
          ?>
            <a class="btn btn-sm btn-success" disabled="true"><i class="fa fa-download"></i> Absen Masuk</a>
            <a class="btn btn-sm btn-danger" disabled="true"><i class="fa fa-upload"></i> Absen Pulang</a>
          <?php
