        ...
        <div class="x_panel">
          ...
          <?php }else if($this->session->flashdata('gagal')){?>
            <div class="alert alert-danger alert-dismissible" role="alert">
              <p><center>PROSES GAGAL<br><?= $this->session->flashdata('gagal'); ?><br>Terimakasih</center></p>
            </div>
          <?php } ?>
          <div class="x_content">
              <table class="table table-bordered table-striped" id="lookup">
                ...
                <tbody>
                  <?php
                    ...
                    $sql      = "SELECT * FROM abe_spk_all WHERE id_karyawan = '$id_user' ORDER BY tgl_input DESC";
...
<script type="text/javascript">
  ...
  function pending_spk(id, spk, id_detail)
  {
      $('[name="id_spk"]').val(id);
      $('[name="no_spk"]').val(spk);
  ...
  function selesai_spk(id, spk, id_detail)
  {
      $('[name="id_spk"]').val(id);
      $('[name="no_spk"]').val(spk);
      $('[name="id_detail"]').val(id_detail);
              ...
              <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?= base_url(); ?>user/spk/pending_spk">
                <div class="form-body">
                  <div class="form-group">
                    ...
                    <label style="text-align: left" class="control-label col-md-12 col-sm-12">Keterangan Pending :</label>
                    <div class="col-md-12 col-sm-12">
                      <textarea class="form-control" rows="10px" name="alasan" required="true"></textarea>
                    </div>
                  </div>
                </div>
                <div class="modal-footer">
