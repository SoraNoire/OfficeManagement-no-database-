    ...
    <div class="row">
        ...
        <div class="x_panel">
          <div class="x_title">
            ...
            <ul class="nav navbar-right panel_toolbox">
              <a href="<?= base_url('user/spk/spk') ?>" class="btn btn-sm btn-warning"><i class="fa fa-reply"></i> Back</a>
              <button  type="button" class="btn btn-sm btn-primary"><?= date('d M Y'); ?></button>
            </ul>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?= base_url(); ?>user/spk/selesai_spk_all">
              <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="form-body">
                <div class="form-group">
                  <label class="control-label col-md-3 col-sm-12">Nomor SPK</label>
                  <div class="col-md-8 col-sm-12">
                    <input type="text" name="no_spk" value="<?= $record['no_spk'] ?>" class="form-control" readonly="true" >
                    <input type="hidden" name="id_spk" value="<?= $record['id_spk'] ?>" >
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-md-3 col-sm-6">Dibuat Oleh</label>
                  <div class="col-md-4 col-sm-6">
                    <input type="text" value="<?= $record['nama_user'] ?>" class="form-control" readonly="true" >
                  </div>
                  <label class="control-label col-md-1 col-sm-6">Divisi</label>
                  <div class="col-md-3 col-sm-6">
                    <input type="text" value="<?= $record['divisi'] ?>" class="form-control" readonly="true" >
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-md-3 col-sm-6">Tanggal Input</label>
                  <div class="col-md-4 col-sm-6">
                    <input type="text" value="<?= date('d-m-Y H:i:s', strtotime($record['tgl_input']))?>" class="form-control" readonly="true">
                  </div>
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            <div class="col-sm-12" >
              <textarea name="penyelesaian" rows="10"></textarea>
            </div>
