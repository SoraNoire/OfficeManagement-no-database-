  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Rekap Detail Data Kehadiran Karyawan</h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <div class="" role="tabpanel" data-example-id="togglable-tabs">
              <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                <li role="presentation" class="active"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Data Detail Kehadiran Karyawan</a>
                </li>
              </ul>
              <div id="myTabContent" class="tab-content">
                <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                  <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?= base_url(); ?>hrd/boss_pintar/proses_rekap_detail" >
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Data Detail Kehadiran Karyawan</h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
                <?php
                ...
                <table id="example" class="display nowrap" style="width:100%">
                    ...
                    <tbody>
                    <?php
                        $sql    = "SELECT * FROM abe_absensi_detail_boss_pintar WHERE tanggal BETWEEN '$tgl_awal' AND '$tgl_akhir' GROUP BY nik";
                        ...
                        echo "<tr>
                                ...
                                for ($i=$tgl; $i < $jumlahhari+1; $i++) {
                                    ...
                                    //echo $hari;
                                    //echo $tgl_absen." - ";
                                    $jam_awal   = $this->db->query("SELECT * FROM abe_absensi_detail_boss_pintar WHERE nik = $nik AND tanggal = '$tgl_absen' GROUP BY nik")->row_array();
                                    $log_date   = $this->db->query("SELECT * FROM abe_absensi_detail_boss_pintar WHERE nik = $nik AND tanggal = '$tgl_absen'")->result();
                                    //$log_date   = date('H:i', strtotime($jam_awal['log_date']));
                                    //$jam_pulang = date('H:i', strtotime($jam_awal['tgl_akhir']));
                                    if($jam_awal['log_date'] == ''){
                                        ...
                                        echo "<td>";
                                        foreach($log_date as $log){
                                            $logs = date('H:i', strtotime($log->log_date));
                                            echo $logs."<br>";
                                            //echo "tes";
                                        }
                                        echo "</td>";
