  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Preview File Absensi Boss Pintar <small></small></h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <form method="post" action="<?= base_url("hrd/boss_pintar/form_upload"); ?>" enctype="multipart/form-data">
              <!--
            ...
            if(isset($_POST['preview'])){ // Jika user menekan tombol Preview pada form
              ...
              echo "<form method='post' action='".base_url("hrd/boss_pintar/import_data")."'>";
              ...
              foreach($sheet as $row){
                ...
                $nik        = $row['F']; // Ambil data NIK
                $nama       = $row['G']; // Ambil data nama
                $cabang     = $row['E']; // Ambil data cabang
                $kategori   = $row['B'];
                ...
                if($nik == "" && $nama == "" && $cabang == "" && $tanggal == "" && $tgl_awal == "" && $tgl_akhir == "")
                ...
                if($numrow > 1){
                  ...
                  $tgl_awal_td    = ( ! empty($tgl_awal))? "" : " style='background: #E07171;'"; // Jika Tanggal Awal kosong, beri warna merah
                  $tgl_akhir_td   = ( ! empty($tgl_akhir))? "" : " style='background: #E07171;'"; // Jika Tanggal Akhir kosong, beri warna merah
                  // Jika salah satu data ada yang kosong
                  if($nik == "" or $nama == "" or $cabang == "" or $kategori == "" or $tanggal == "" or $tgl_awal == "" or $tgl_akhir == ""){
                  ...
                  echo "<td".$tgl_awal_td.">".$tgl_awal."</td>";
